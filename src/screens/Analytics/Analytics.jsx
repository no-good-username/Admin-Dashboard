  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerSubtitle}>Performance metrics and insights</Text>
      </View>
      ...
      <View style={styles.metricsHeader}>
        ...
        <Text style={styles.sectionSubtitle}>Overview of system performance</Text>
      </View>
      ...
      <View style={styles.chartContainer}>
        ...
        <Text style={styles.chartSubtitle}>Percentage of tasks completed on time</Text>
        <LineChart
      ...
      <View style={styles.block}>
        <View style={styles.sectionHeaderRow}>
          ...
          <Text style={styles.sectionSubtitle}>Maintenance efficiency by area</Text>
        </View>
          ...
          return (
            <View key={division} style={styles.divisionItem}>
              <View style={styles.divisionNameContainer}>
                <View style={[styles.divisionDot, { backgroundColor: getColorForPercentage(percentages[index]) }]} />
              ...
              <View style={styles.progressBarContainer}>
                <View 
                  style={[
                    styles.progressBar, 
                    { width: `${percentages[index]}%`, backgroundColor: getColorForPercentage(percentages[index]) }
                  ]} 
                />
              </View>
              <Text style={styles.divisionPercentage}>{percentages[index]}%</Text>
            </View>
          );
        })}
      </View>
      ...
      <View style={styles.block}>
        <View style={styles.sectionHeaderRow}>
          ...
          <Text style={styles.sectionSubtitle}>Individual performance metrics</Text>
        </View>
        
        <View style={styles.technicianTable}>
          <View style={styles.tableHeader}>
            <Text style={[styles.tableCell, styles.tableHeaderCell, styles.nameCell]}>Technician</Text>
            <Text style={[styles.tableCell, styles.tableHeaderCell, styles.dataCell]}>Tasks</Text>
            <Text style={[styles.tableCell, styles.tableHeaderCell, styles.dataCell]}>Avg. Time</Text>
            <Text style={[styles.tableCell, styles.tableHeaderCell, styles.dataCell]}>Rating</Text>
          </View>
          ...
          {[
            ...
            <View key={index} style={styles.tableRow}>
              <View style={[styles.tableCell, styles.nameCell]}>
                <FontAwesome5 name="user-alt" size={14} color="#555" style={styles.techIcon} />
                <Text style={styles.techName}>{tech.name}</Text>
              </View>
              <Text style={[styles.tableCell, styles.dataCell, styles.tasksValue]}>{tech.tasks}</Text>
              <Text style={[styles.tableCell, styles.dataCell]}>{tech.time}</Text>
              <View style={[styles.tableCell, styles.dataCell, styles.ratingContainer]}>
